...
var progress80 = {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'div',
      { className: 'progress' },
      _react2.default.createElement('div', { className: 'progress-bar', role: 'progressbar', style: { width: data.progress + '%' }, 'aria-valuenow': '{data.progress}', 'aria-valuemin': '0', 'aria-valuemax': '100' })
    )
  );
};
