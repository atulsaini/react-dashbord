...
var progress80 = {
  ...
  return _react2.default.createElement(
    'div',
    { key: 'bullet-' + k, className: 'progress-container pb-3' },
    ...
    _react2.default.createElement(
      'div',
      { className: 'progress' },
      _react2.default.createElement('div', { className: 'progress-bar bg-' + data.color, role: 'progressbar', style: { width: data.progress + '%' }, 'aria-valuenow': '{data.progress}', 'aria-valuemin': '0', 'aria-valuemax': '100' })
    )
  );
};
